...
namespace ARŞİV_ODASI_PROJESİ
{
    public partial class KAYDET : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("insert into EVRAK (EVRAK_AD ,DOSYA_ID, KLASÖR_ID,RAF_ID,Bölüm_ID, Oda_ID) values (@p1,@p2,@p3,@p4,@p5,@p6)", baglanti.baglanti());
            komut.Parameters.AddWithValue("@p1", textBox_evrak.Text);
            komut.Parameters.AddWithValue("@p2", comboBox_DAD.SelectedValue);
            komut.Parameters.AddWithValue("@p3", comboBox_BAD.SelectedValue);
            komut.Parameters.AddWithValue("@p4", comboBox_KAD.SelectedValue);
            komut.Parameters.AddWithValue("@p5", comboBox_RAD.SelectedValue);
            komut.Parameters.AddWithValue("@p6", comboBox_OAD.SelectedValue);
