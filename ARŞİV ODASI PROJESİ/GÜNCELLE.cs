...
namespace ARŞİV_ODASI_PROJESİ
{
    public partial class GÜNCELLE : Form
    {
        ...
        {
            SqlCommand komut = new SqlCommand("update EVRAK set EVRAK_AD=@p1 where EVRAK_ID=@p2", baglanti.baglanti());
            komut.Parameters.AddWithValue("@p1", textBox_evrak.Text);
            komut.Parameters.AddWithValue("@p2", textbox_evrakid.Text);
        ...
        private void comboBox_DAD_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void textbox_evrakid_TextChanged(object sender, EventArgs e)
        {
